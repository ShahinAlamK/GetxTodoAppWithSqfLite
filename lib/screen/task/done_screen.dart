  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title:Row(
          ...
          children: [
            ...
            RoundIcon(icon: Icons.done, onPress: (){}),
          ],
        ),
      ),
      ...
      body: Padding(
        ...
        child: Obx((){
          if(taskController.isDoneTaskList.isEmpty){
            return Center(
            ...
            return ListView.builder(
                ...
                itemCount: taskController.isDoneTaskList.length,
                itemBuilder: (_,index){
                  TaskModel taskModel=taskController.isDoneTaskList[index];
                  return Padding(
